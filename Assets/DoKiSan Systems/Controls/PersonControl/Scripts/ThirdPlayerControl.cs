...
namespace DoKiSan.Controls
{
    public class ThirdPlayerControl : MonoBehaviour
    {
        ...
        [SerializeField]private bool isLeftMouseClickEnable;
        ...
        private void OnEnable()
        {
            ...
            inputs.Cinemachine.LeftButtonClick.performed += LeftButtonClick_performed;
        }

        private void LeftButtonClick_performed(InputAction.CallbackContext obj)
        {
            if(isLeftMouseClickEnable)
                selectableRoomSpawn.RoomTeleport();
        }
        ...
        public void EnableLeftMouseClick(bool isEnable)
        {
            isLeftMouseClickEnable= isEnable;
        }
